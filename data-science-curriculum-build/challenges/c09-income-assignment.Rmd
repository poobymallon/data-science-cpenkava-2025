...
-   Document your observations here.
    -   the number of people in a family generally tends to correlate with a higher median income
        -   this kind of breaks down in certain categories especially for 6 person families
    ...
    -   we cannot conclude for certain any inequalities between 2-6 person families because almost all of the confidence intervals overlap
...
-   Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
    -   Just barely - the confidence intervals are all quite similar in width and are centered very close to each to the point they just kind of blur together
...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    -   Generally, the larger the population, the lower the standard error - I would assume this is because standard error divides by the square root of n as part of the equation
-   What does this *overall* trend tell you about the relative ease of studying small vs large counties?
    -   This would mean that smaller counties are harder to study because they are more varied, so you have to get larger samples to have the same amount of confidence.
...
-   The states with the highest SE are North Dakota, Wyoming, Montana, Alaska, and South Dakota
    -   This is highly in line with our graph from earlier showing that SE is inversely correlated with population!
