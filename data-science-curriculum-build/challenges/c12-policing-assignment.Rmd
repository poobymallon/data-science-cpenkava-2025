...
-   i'm guessing race Raw is an unprocessed version of subject race - it seems like raw_Race is just a more specific version - there's \~92000 mismatches, and they're basically all just when the raw is more specific with middle eastern and subject brings it to just asian and similar behaviors
