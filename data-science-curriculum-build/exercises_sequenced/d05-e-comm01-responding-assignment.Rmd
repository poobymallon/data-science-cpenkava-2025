...
-   Is the bolded response **constructive** or **destructive**? Why?
    -   constructive, is appreciative of the fact that they caught something and doesn't dismiss them
...
-   Is the bolded response **constructive** or **destructive**? Why?
    -   but... it is destructive in that it intentionally dismisses their point and belittles them
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
...
-   Is the bolded response **constructive** or **destructive**? Why?
    -   its somewhat neutral, but the fact that it sets up the discussion to go a way that the presenter didn't want makes it destructive
