...
**Observations**: - same data, more info - 2 seaters always rear wheel, pickups always 4 wheel, people rarely pick cars who don't have the option of 4 wheel drive,
...
v2 allowed more information to come through, with the difference of stacked bars
...
**Observations** - honestly dodge was harder to read, especially when the land of big pink boxes in the middle exists, plus a lot of the cool colors start blending together.
