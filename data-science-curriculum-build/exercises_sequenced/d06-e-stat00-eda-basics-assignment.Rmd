...
**Observations**: - Ideal is the cut sub-category that contains the most data. This means that the hypothesis was incorrect.
...
**Observations**: - This graph is entirely helpful. There is enough data to make the graph incomprehensible.
...
**Observations**: - This graph would actually suggest the opposite of hypothesis 2 - the median price for ideal is lower than the median price.
...
**Observations**: - fair diamonds have far and beyond larger carat values that other cuts, both in median and in outliers
