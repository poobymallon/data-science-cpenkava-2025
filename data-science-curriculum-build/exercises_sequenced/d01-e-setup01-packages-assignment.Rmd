...
install will install them onto your computer, but library makes it available to the file, I think. install packages is just to install new packages that you dont already have. library is when you want to load it into a new file, so each time you want to run and edit a new file
